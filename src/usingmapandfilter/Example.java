...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    final List<String> expectedReversed =
        List.of(
            "gnirtsa1",
            "gnirtsrehtona2",
            "tna",
    ...
    final List<Double> expectedSqrtsOfFirstDigits =
        List.of(Math.sqrt(1), Math.sqrt(2), Math.sqrt(9), Math.sqrt(8));
    ...
    System.out.println(
        "Two ways of reversing " + strings + " give " + reversed1 + " and " + reversed2);

    System.out.println(
        "Two ways of taking the square roots of the first digits of any strings in "
            + strings
            + " that start with digits give "
            + sqrtsOfFirstDigits1
            + " and "
            + sqrtsOfFirstDigits2);
