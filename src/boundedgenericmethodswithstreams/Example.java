package boundedgenericmethodswithstreams;
...
public class Example {
  ...
  static <E, C extends Collection<E>> Optional<C> getSmallestCollection(List<C> collections) {
    return collections.stream().reduce((c1, c2) -> c1.size() > c2.size() ? c2 : c1);
  }
  ...
  public static void main(String[] args) {
    ...
    final List<String> l3 = new ArrayList<>(List.of("mouse", "fox", "owl", "snake", "gruffalo"));
    final List<String> l4 =
        new ArrayList<>(List.of("dog", "cat", "frog", "bird", "witch", "broomstick"));
