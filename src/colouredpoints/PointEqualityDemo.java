  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Points first = "
            ...
            + third
            + " are "
            + (first.equals(third) ? "" : "not ")
            + "equal");

    System.out.println(
        "Points firstColoured = "
            + firstColoured
            + " and secondColoured = "
            + secondColoured
            + " are "
            + (firstColoured.equals(secondColoured) ? "" : "not ")
            + "equal");
    System.out.println(
        "Points secondColoured = "
            + secondColoured
            + " and firstColoured = "
            + firstColoured
            + " are "
            + (secondColoured.equals(firstColoured) ? "" : "not ")
            + "equal");
    ...
    System.out.println(
        "Points firstColoured = "
            ...
            + thirdColoured
            + " are "
            + (firstColoured.equals(thirdColoured) ? "" : "not ")
            + "equal");
    ...
    System.out.println(
        "Points first = "
            ...
            + firstColoured
            + " are "
            + (first.equals(firstColoured) ? "" : "not ")
            + "equal");
    System.out.println(
        "Points firstColoured = "
            + firstColoured
            ...
            + first
            + " are "
            + (firstColoured.equals(first) ? "" : "not ")
            + "equal");
  }
}
